...
def main():
    ...
    print("*" * 60)
    # describe(r"C:\msys64\mingw32\i686-w64-mingw32")
    # print("*" * 60)
    describe(r"C:\msys64\mingw32\i686-w64-mingw32\bin")
    print("*" * 60)
    # describe(r"C:\msys64\mingw64")
    # print("*" * 60)
    describe(r"C:\msys64\mingw64\bin")
    print("*" * 60)
    # describe(r"C:\msys64\mingw64\x86_64-w64-mingw32")
    # print("*" * 60)
    describe(r"C:\msys64\mingw64\x86_64-w64-mingw32\bin")
    print("*" * 60)
